...
def load_dataset():
	...
	X_train = load_15_data('tonyu_data/train_f.15')
	y_train = load_15_lable_data('tonyu_data/train_f.lable')
	X_test = load_15_data('tonyu_data/test_f.15')
	y_test = load_15_lable_data('tonyu_data/test_f.lable')
...
def build_mlp(input_var=None):
	...
	l_in = lasagne.layers.InputLayer(shape=(None, 1,15),
									 input_var=input_var)
...
def build_cnn(input_var=None):
	...
	#network = lasagne.layers.InputLayer(shape=(None, 1, 28, 28),
	#									input_var=input_var)
	network = lasagne.layers.InputLayer(shape=(None, 15),
										input_var=input_var)
...
def main(model='mlp', num_epochs=50):
	...
	print ("ivector :%s" % target_var.dtype)
